<template>
    <div style="background-color:rgba(255, 255, 255, 0.4); margin:2px; border-radius:10px; padding:25px; " >
        ...
        <div>
            ...
            <input type="text" class="in" v-model="state.nickname" @keyup="handleNickcheck"/>
        </div>
        ...
        <div>
            ...
            <input type="text" class="in" v-model="state.phone" @keyup="handlePhonecheck" />
        </div>
        <div style="text-align:center">
...
export default {
    setup () {
        ...
        return {state,handleData,handleUpdate,handleNickcheck,handlePhonecheck}
    }
}
</script>
